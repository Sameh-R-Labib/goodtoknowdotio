...
<?php global $g; ?>
    <p><span class="tooltip">ⅈ <span class="tooltiptext tooltip-top">Warning: Records will be deleted automatically
        ...
        <span class="tooltip">ⅈ <span class="tooltiptext tooltip-top">In other words you may have sold 30 BTC at one
    ...
    <section>
        ...
        <p>
            <label for="currency_transacted">Priced In — Fiat <span class="tooltip">ⅈ<span class="tooltiptext
        ...
        <p>
            <label for="commodity_amount">Amount Sold <span class="tooltip">ⅈ<span class="tooltiptext
        ...
        <p>
            <label for="commodity_type">Type <span class="tooltip">ⅈ<span class="tooltiptext
        ...
        <p>
            <label for="tax_year">Year <span class="tooltip">ⅈ
