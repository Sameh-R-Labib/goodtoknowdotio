...
<?php require TOPFORFORMPAGES; ?>
    <form action="/ax1/StartATaxableIncomeEventProcessor/page" method="post">
        <h1>Create a Taxable Income Event 📽</h1>
        ...
        <section>
            ...
            <p>
                ...
                <input id="year_received" name="year_received" type="text"
                       value="<?= $g->saved_arr01['year_received'] ?>" required minlength="4" maxlength="6"
            ...
            <p>
                ...
                <input id="amount" name="amount" type="text" value="<?= $g->saved_arr01['amount'] ?>" required
                       minlength="1" maxlength="33" size="33" placeholder="150.24">
            </p>
            <p>
                <label for="comment">Comment (🚫 markdown ✅ emoji ✅ line-break): </label>
                <textarea id="comment" name="comment" rows="5" cols="77" wrap="soft" maxlength="800"
                          placeholder="The frequency with which I receive this income is _ _."><?= $g->saved_arr01['comment'] ?></textarea>
            </p>
        </section>
