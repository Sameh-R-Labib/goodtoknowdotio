    ...
    <div id="maincontent">
        ...
        <?php if (!empty($g->array)): ?>
            ...
            <?php foreach ($g->array as $key => $object): ?>
                ...
                <p><b>Price Per Unit Bought: </b><?= $object->currency_transacted ?>&nbsp;<?= $object->price_bought ?>
                </p>
                <p><b>Price Per Unit Sold: </b><?= $object->currency_transacted ?>&nbsp;<?= $object->price_sold ?></p>
                <p><b>What Was Sold: </b><?= $object->commodity_type ?>&nbsp;<?= $object->commodity_amount ?></p>
                <p><b>Label of Commodity Record From Which It Was Sold: </b><?= $object->commodity_label ?></p>
