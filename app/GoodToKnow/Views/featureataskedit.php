    ...
    <form action="/ax1/FeatureATaskUpdate/page" method="post">
        ...
        <section>
            ...
            <p>
                ...
                <input id="cycle_type" name="cycle_type" type="text" value="<?= $g->object->cycle_type ?>" required
            ...
            <p>
                ...
                <textarea id="comment" name="comment" rows="4" cols="77" wrap="soft" maxlength="800" spellcheck="false"
                          placeholder="Remarks about decision whether to continue this task"><?= $g->object->comment ?></textarea>
            </p>
        </section>
