...
<?php require CBSOFREGULARPAGES; ?>
    ...
    <div id="maincontent">
        ...
        <p><a href="/ax1/cleanup_years_taxable_income_events/page">Purge a Specific Year's Taxable Income Events</a></p>
        <p><a href="/ax1/abolish_years_commodities_sold/page">Purge a Specific Year's Commodity Sold Records</a></p>
    </div><!-- End maincontent -->
