...
$sql = 'SELECT * FROM `possible_tax_deduction` WHERE `year_paid` = ' . $g->db->real_escape_string((string)$g->year_paid);
...
if (!$g->array) {
    ...
    breakout(" For <b>$g->year_paid</b> I could NOT find any Tax Deductions. ");
