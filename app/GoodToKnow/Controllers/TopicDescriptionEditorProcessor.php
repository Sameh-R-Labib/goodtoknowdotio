...
class TopicDescriptionEditorProcessor
{
    function page()
    {
         ...
         *  3) Save the topic name in the session (we know what that is from the $app_state->special_topic_array.)
        ...
        $_SESSION['saved_str01'] = $app_state->special_topic_array[$chosen_topic_id];
