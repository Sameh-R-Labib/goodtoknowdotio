...
class ConceiveAPossibleTaxDeduction
{
    public function page()
    {
         ...
         *
         * The process will
         * ask the user to ONLY supply a possible_tax_deduction
         ...
         * form for the user to supply the possible_tax_deduction
         * label + year_paid for the "to be created" possible_tax_deduction
         * record.
         */
